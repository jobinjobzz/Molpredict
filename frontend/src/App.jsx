  ...
  return (
    ...
    >
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <span style={{ fontSize: 12, color: "#94a3b8", letterSpacing: "0.05em", textTransform: "uppercase", fontFamily: "'JetBrains Mono', monospace" }}>
          {prop.name}
        </span>
        <span style={{
          background: c.dot, borderRadius: "50%", width: 8, height: 8, display: "inline-block"
        }} />
      </div>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          <div>
            <div style={{ fontFamily: "'Space Mono', monospace", fontSize: 16, fontWeight: 700, letterSpacing: "-0.02em" }}>
              MolPredict
            </div>
      ...
      <div style={{ maxWidth: 960, margin: "0 auto", padding: "48px 24px 0" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 48, animation: "fadeUp 0.5s ease" }}>
          ...
          <p style={{ color: "#475569", fontSize: 15, maxWidth: 420, margin: "0 auto", lineHeight: 1.7 }}>
            Input a SMILES string to compute drug-likeness, physicochemical properties, and Lipinski compliance.
          </p>
        </div>
        ...
        <div style={{
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr auto", gap: 12, marginBottom: 16 }}>
            <div>
              <label style={{ fontSize: 11, color: "#475569", textTransform: "uppercase", letterSpacing: "0.08em", fontFamily: "'JetBrains Mono', monospace", display: "block", marginBottom: 6 }}>
                SMILES String *
              </label>
              <input
                value={smiles}
          ...
          <div style={{ display: "flex", gap: 10, alignItems: "center", flexWrap: "wrap" }}>
            <button onClick={predict} disabled={loading || !smiles.trim()}
              style={{
                background: smiles.trim() ? "linear-gradient(135deg, #1d4ed8, #0ea5e9)" : "#0f1923",
                border: "none",
                borderRadius: 8,
                padding: "11px 28px",
                color: smiles.trim() ? "#fff" : "#334155",
                fontFamily: "'Space Mono', monospace",
                fontSize: 13,
                fontWeight: 700,
                cursor: smiles.trim() ? "pointer" : "not-allowed",
            ...
            {smiles && (
              <button onClick={() => { setSmiles(""); setMolName(""); setResult(null); setError(null); }}
                style={{
                  background: "transparent", border: "1px solid #1e3a5c",
                  borderRadius: 8, padding: "11px 18px", color: "#475569",
        ...
        {examples.length > 0 && (
          <div style={{ marginBottom: 36, animation: "fadeUp 0.5s ease 0.2s both" }}>
            <div style={{ fontSize: 11, color: "#334155", textTransform: "uppercase", letterSpacing: "0.08em", fontFamily: "'JetBrains Mono', monospace", marginBottom: 10 }}>
              Try an example →
            </div>
        ...
        {error && (
          <div style={{
            background: "#2b0d0d", border: "1px solid #5c1a1a",
        ...
        {result && result.valid && (
          <div style={{ animation: "fadeUp 0.4s ease" }}>
            ...
            {/* Molecule header */}
            <div style={{
              background: "#0a1520", border: "1px solid #0f2030",
              ...
              <div>
                {result.name && (
                  <div style={{ fontFamily: "'Space Mono', monospace", fontSize: 22, fontWeight: 700, marginBottom: 4 }}>
                    {result.name}
                  </div>
                )}
                <div style={{
                  fontFamily: "'JetBrains Mono', monospace", fontSize: 13,
                  color: "#60a5fa", background: "#0f1f2e",
                  padding: "4px 10px", borderRadius: 6, display: "inline-block", marginBottom: 10,
                }}>
            ...
            <div style={{
              ...
              <div style={{ fontSize: 11, color: "#334155", marginLeft: "auto", alignSelf: "center" }}>
            ...
            <div style={{
              ...
              background: "#08111a", borderRadius: 10,
              fontSize: 11.5, color: "#334155", lineHeight: 1.7,
              fontFamily: "'JetBrains Mono', monospace",
            }}>
              ⚠ These are computational predictions only. Actual biological activity requires experimental validation.
              Properties computed using RDKit. QED score from Bickerton et al. (2012).
            </div>
          </div>
        )}
